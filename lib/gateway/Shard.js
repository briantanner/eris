    ...
    */
    ...
    loadGuild(guildID) {
        ...
        const p = new Promise(async (res, rej) => {
            try {
                let [guild, channels] = await Promise.all([
                    this.requestHandler.request("GET", Endpoints.GUILD(guildID), true),
                    this.requestHandler.request("GET", Endpoints.GUILD_CHANNELS(guildID), true),
                ]);
        ...
        setTimeout(() => {
            ...
            return rej("Guild loading timed out after 10s.");
        }, 10000);
